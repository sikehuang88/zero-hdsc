...
class EmotionFrame(BaseModel):
    ...
    def presentation_data(self) -> dict[str, object]:
        ...
        return {
            ...
            "surface_mask": (
                self.surface_mask.model_dump(mode="json")
            ...
            "voice_segments": [
                item.model_dump(mode="json") for item in self.voice_segments
            ],
        }


__all__ = ["EmotionComponent", "EmotionFrame", "VoicePerformanceSegment"]
